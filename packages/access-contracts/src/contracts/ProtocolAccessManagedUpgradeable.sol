 ...
 */
contract ProtocolAccessManagedUpgradeable is
    ...
    ContextUpgradeable
{
    ...
    bytes32 public immutable SUPER_KEEPER_ROLE = keccak256("SUPER_KEEPER_ROLE");
     ...
     */
    bytes32 public immutable DECAY_CONTROLLER_ROLE =
     ...
     */
    bytes32 public immutable ADMIRALS_QUARTERS_ROLE =
    ...
    IProtocolAccessManager internal immutable _accessManager;
    ...
    constructor(address accessManager) {
        ...
        _accessManager = IProtocolAccessManager(accessManager);
    }
